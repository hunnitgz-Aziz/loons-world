...
function Game() {
  ...
  this.init = function() {
    ...
    if (this.bgCanvas.getContext) {
      ...
      this.shipStartY = this.shipCanvas.height/2 - imageRepository.spaceship.height;
      this.shipStartX = this.shipCanvas.width/10 - imageRepository.spaceship.width/2;
